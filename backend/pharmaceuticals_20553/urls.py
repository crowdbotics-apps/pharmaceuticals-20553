"""pharmaceuticals_20553 URL Configuration
...
admin.site.site_header = "Pharmaceuticals"
admin.site.site_title = "Pharmaceuticals Admin Portal"
admin.site.index_title = "Pharmaceuticals Admin"

# swagger
api_info = openapi.Info(
    title="Pharmaceuticals API",
    default_version="v1",
    description="API documentation for Pharmaceuticals App",
)
